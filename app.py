...
# Admin routes moved to routes/admin.py blueprint
# Analytics route registered separately above (at /analytics)
...
# Transaction matching routes moved to routes/matching.py blueprint
# /match, /match/review, /match/review-pending, /match/apply-pending, /match/reject-pending, /match/undo
# /apply-match, /reject-match, /sync-banks registered separately above for backward compatibility
